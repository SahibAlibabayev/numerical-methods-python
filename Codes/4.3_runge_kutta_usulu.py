...
default_n = 10
print("-" * 55)
print("  RUNGE-KUTTA 4-CÜ TƏRTİB ÜSULU İLƏ HƏLL")
print("-" * 55)
...
for i in range(1, n + 1):
    # 4-cü tərtib Runge-Kutta əmsallarının hesablanması
    k1 = f(x, y)
    k2 = f(x + h / 2.0, y + (h * k1) / 2.0)
    k3 = f(x + h / 2.0, y + (h * k2) / 2.0)
    k4 = f(x + h, y + h * k3)
    
    # Növbəti yaxınlaşmanın hesablanması
...
print(f"    Runge-Kutta ilə y(x)   : {y:.8f}")
print("=" * 45)
